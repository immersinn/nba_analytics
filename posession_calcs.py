...
def determineBallPosession(pbd, radius, max_dist=3, max_radius=5):
...
def determineBallTransitions(df, pids):
    ...
    poss = determineBallPosession(pbd, radius)
...
def calcP2PDist(player_a, player_b):
    """
...
##    player_ids = list(pd.unique(df.player_id))
    ...
    for pid in player_ids:
        ...
        dist = calcP2PDist(ball_df, player_df)
