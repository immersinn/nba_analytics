...
sys.path.append('/home/immersinn/gits/')
##from dbconns import connectMon
from dbinterface_python.dbconns import connectMon   # need to make this switch
...
def main():
##    dump_path = '/home/immersinn/Data/nba_dumps/test_movement.pkl'
    game_id = "0041400235"
...
##    with open(dump_path, 'w') as f1:
##        pickle.dump(moments, f1)
##    print('fine')
